...
function IP(A,B,C,D,E,F,G,H,Ia,Ib,J,K,L,M,N,O,P,X) {
	...
	if (B==1){ //創
		...
		IC =( 0.9*G + 2*N ) * ( A*1.5 ) * (1.3*((Ia**2)/2+0.5)) * (L/2+0.5) * (H*0.3+0.7);
		ID = ( 2/5*F +3/5 ) * ( P * (0.4*J+0.6) ) * (0.25*M);
		
		IE =( 0.5*G + 1.5*N ) * ( A*1.5 ) * (((Ia**2)/4+0.75)) * (L/2+0.5) * (H*0.1+0.9);
		...
		IE =( 0.5*G + 1.5*N ) * ( A*1.5 ) * (((Ia**2)/4+0.25)) * (L/2+0.5)*(H*0.1+0.9);
		IF = ( 3/5*F +2/5 ) * ( P * (0.4*J+0.6) ) * (0.25*M)*2;
		...
		IC =( 0.5*G + 2*N ) * ( A*1.5 ) * (1.3*((Ia**2)/3+0.5)) * (L/2+0.5)*(H*0.2+0.8);
		ID = ( 2/7*F +5/7 ) * ( P * (0.4*J+0.6) ) * (0.25*M);
		
		IE =( 0.3*G + 1.5*N ) * ( A*1.5 ) * (((Ia**2)/5+0.8)) * (L/2+0.5)*(H*0.1+0.9);
		...
		IC =( 0.9*G + 2*N ) * ( A*1.5 ) * (1.3*((Ia**2)/2+0.5)) * (L/2+0.5)*(H*0.2+0.8);
		ID = ( 2/5*F +3/5 ) * ( P * (0.4*J+0.6) ) * (0.25*M);
...
function COST(A,B,C,D,E,F,G,H,Ia,Ib,J,K,L,M,N,O,P,X) {
	...
	CA = G*((D*0.25+0.75) + C) * ((F*0.3+0.7)*2+O) *(J*0.5+0.5)
	...
	CA = G*((D*0.25+0.75) + C) * ((F*0.5+0.5)*2+O) *(J*0.5+0.5)*(L*0.4+0.6)
	CB = ((0.35*H+0.65)+(K**2/1.5)/2) * (N*0.25+0.75) * Ib
